...
import AgeArea from './components/AgeArea.vue'
  ...
  methods: {
    ...
    dataRegister() {
      if(this.expanded == 1) {
        ...
        this.user_info = [this.user_id, this.user_name,  this.gender, this.email, this.address, this.formatDate, this.user_role];
